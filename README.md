...
### 🛠️ Technical Toolkit
- **Hardware:** PCB Repair, Micro-soldering, Thermal Imaging, Mobile Forensics.
- **Systems:** Windows Server, Active Directory, Linux (Ubuntu/Debian).
- **Security:** Network Analysis (Wireshark), Asset Disposal, GRC Frameworks.
- **Scripting:** Python (Intermediate logic & automation).

### 📬 Connect with Me
- **Location:** San Diego, CA area
- **Business:** CEO/CISO at AtoZ Wireless & Advertising
- **Interests:** NHL (Dallas Stars), Drone Tech, and Hardware Forensics.

---
*"Securing the future by mastering the hardware of today."*
